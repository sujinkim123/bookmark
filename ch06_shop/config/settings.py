...
SECRET_KEY = '5otvqb_3*+k*ko4sh+=6^a9++&vi8ha7)^jci2ez$u2nf6l!1o'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'onlineshop',
        'USER': 'root',
        'PASSWORD': 'znjzk7506*', # !!! 자신의 비밀번호로 변경
...
IAMPORT_KEY = '6195908524102163'  #API key
IAMPORT_SECRET = 'JayMs9q8kmHgnyQF11IgbpDnJTcvIHFsRdeknFsI29YpHP4JQN01cDoWxArgi6IakWuICWqE6o3Od7x4'  # Secret key
